...
// 			</div>
// 		</div>
// 		<div className="relative flex col-span-12 bg-center bg-no-repeat bg-cover bg-gray-500 xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96" style="background-image: url('https://source.unsplash.com/random/239x319');">
// 			<span className="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6 border-blue-600 text-gray-100">paris, france</span>
