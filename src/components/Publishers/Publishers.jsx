...
export const Publishers = () => {
  ...
  console.log("publishers in publishers section", publishers);
  return (
      ...
      publishers.map((publisher) => (
        ...
        <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
            <p className="mb-1 text-lg font-bold text-gray-100">{publisher?.name}
            </p>
            <p className="mb-4 text-xs text-gray-100">Publisher</p>
            <p className="mb-4 text-xs tracking-wide text-gray-400">
             One of the Best Publication you have ever seen.
            </p>
