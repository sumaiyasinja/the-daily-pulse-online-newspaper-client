...
const AllArticles = () => {
  ...
  const handleViewDetails = (article) => {
    ...
    axiosPublic.put(`/articles/${article._id}`, {
        ...
        />
            ...
            <div key={article._id} className="grid py-7 sm:grid-cols-4">
              <div className="mb-4 sm:mb-0">
                  <p className="text-blue-600 ml-14 capitalize">{article?.tags}</p>
                  <img src={article?.image} alt="" className="w-40 rounded-xl shadow-md"/>
              ...
              <div className="sm:col-span-3 lg:col-span-2">
                ...
                <div onClick={() => handleViewDetails(article)} className="mt-4 flex justify-center items-center text-blue-800 hover:text-blue-600">
                    Read More
                    <svg
